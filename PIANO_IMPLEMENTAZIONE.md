...
The next best implementation is `ProductGalleryService` (already completed), followed by splitting `ProductSynchronizer`. Both are queue-independent and can be committed as separate steps.
