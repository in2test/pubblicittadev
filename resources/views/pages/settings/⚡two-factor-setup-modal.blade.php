...
>
        <div class="space-y-6">
            <div class="flex flex-col items-center space-y-4">
                <div class="p-0.5 w-auto rounded-full border border-gray-100 bg-gray-50 shadow-sm">
                    <div class="p-2.5 rounded-full border border-gray-200 overflow-hidden bg-gray-100 relative">
                        <div class="flex items-stretch absolute inset-0 w-full h-full divide-x [&>div]:flex-1 divide-gray-200 justify-around opacity-50">
                            @for ($i = 1; $i <= 5; $i++)
                                <div></div>
                            @endfor
                        </div>

                        <div class="flex flex-col items-stretch absolute w-full h-full divide-y [&>div]:flex-1 inset-0 divide-gray-200 justify-around opacity-50">
                            @for ($i = 1; $i <= 5; $i++)
                                <div></div>
                            @endfor
                        </div>
            ...
            @else
                ...
                <div class="space-y-4">
                    <div class="relative flex items-center justify-center w-full">
                        ...
                        <span class="relative px-2 text-sm bg-gray-50 text-gray-600">
                    ...
                    >
                        <div class="flex items-stretch w-full border rounded-xl">
                            @empty($manualSetupKey)
                                <div class="flex items-center justify-center w-full p-3 bg-gray-100">
