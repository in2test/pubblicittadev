...
<section class="relative min-h-230 flex flex-col lg:flex-row overflow-hidden lg:h-[calc(100svh-100px)]">
    ...
    <div class="w-full lg:w-1/2 bg-surface-container-lowest flex items-center px-8 3xl:px-32 py-24 relative z-10">
        ...
        <div class="absolute top-24 right-0 pointer-events-none opacity-5 select-none">
            <span class="text-9xl font-black text-on-surface">PUBBLICITTA24</span>
        </div>
    </div>
    <!-- Right Side: Imagery -->
    <div class="w-full lg:w-1/2 relative bg-zinc-900 group">
        ...
        <!-- Floating Card -->
        <div
            class="absolute top-20 left-12 lg:left-20 bg-surface-container-lowest p-6 shadow-2xl max-w-xs hidden md:block">
            <div class="font-mono text-[10px] text-primary mb-4">SYSTEM_STATUS: ACTIVE</div>
            <h3 class="text-xl font-bold mb-2">Performance Shell V.2</h3>
            <p class="text-sm text-secondary mb-4 leading-snug">Materiali certificati per condizioni estreme.
                Resistenza all'abrasione +45%.</p>
            <div class="flex justify-between items-center border-t border-surface-container pt-4">
                <span class="font-mono text-xs">SKU: OP-992-BLK</span>
