...
<div class="flex items-baseline gap-4 mb-8">
    ...
    @elseif ($priceData['is_discounted'])
        ...
        <span class="text-lg font-light text-gray-500 line-through tracking-tight">€{{ number_format($priceData['base_price'], 2) }}</span>
    @else
        <span class="text-3xl font-light text-gray-900 tracking-tight">€{{ number_format($priceData['base_price'], 2) }}</span>
    @endif
