    ...
    <div class="px-8 max-w-screen-2xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group flex flex-col">
                ...
                <div class="px-2">
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="font-bold text-sm uppercase">Guscio Tecnico Pro-X</h3>
                        <span class="font-mono text-xs">€124.00</span>
                    </div>
            ...
            <div class="group flex flex-col">
                ...
                <div class="px-2">
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="font-bold text-sm uppercase">Polo Corporate Piqué</h3>
                        <span class="font-mono text-xs">€28.50</span>
                    </div>
                    <span class="font-mono text-[10px] text-secondary uppercase tracking-widest">SKU:
                        OP-POL-22</span>
                </div>
            ...
            <div class="group flex flex-col">
                ...
                <div class="px-2">
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="font-bold text-sm uppercase">Pantalone Multi-Pocket</h3>
                        <span class="font-mono text-xs">€65.00</span>
                    </div>
                    <span class="font-mono text-[10px] text-secondary uppercase tracking-widest">SKU:
                        OP-PNT-45</span>
                </div>
            ...
            <div class="group flex flex-col">
                ...
                <div class="px-2">
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="font-bold text-sm uppercase">Pack Branding Aziendale</h3>
